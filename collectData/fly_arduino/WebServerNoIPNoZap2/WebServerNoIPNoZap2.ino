...
// This version of the code uses a domain name https://www.doesmyrobotunderstand.me/sitran/ not a hard-coded IP address.
// Might be better when/if we don't want to pay for a remote server.
...
void writehomepage ()
{
  ...
  client.print F("Please try <a href = \'http://www.doesmyrobotunderstand.me/sitran/'>AWS Server</a> for starter page");
  sendFooter();
}
