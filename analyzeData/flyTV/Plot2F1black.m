...
subleg=annotation('textbox',[0.8 0.45 0.16 0.03],'color',[1,1,1], 'string', 'Spatial Frequency (cpd)');
set(subleg, 'EdgeColor', [0,0,0]);
...
spt2=subplot(2,2,2,0.1);errorbar(TransExtracted,SEM(:,:,2));
...
subleg=annotation('textbox',[0.8 0.9 0.16 0.03],'color',[1,1,1], 'string', 'Temporal Frequency (Hz)');
set(subleg, 'EdgeColor', [0,0,0]);
